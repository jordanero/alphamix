...
class LD_Score_Regression(object):
    ...
    def __init__(self, y, x, w, N, M, n_blocks, intercept=None, slow=False, step1_ii=None, old_weights=False, separators = None):
        for i in [y, x, w, M, N]:
            try:
                if len(i.shape) != 2:
...
class Hsq(LD_Score_Regression):
    ...
    def __init__(self, y, x, w, N, M, n_blocks=200, intercept=None, slow=False, twostep=None, old_weights=False, separators = None):
        step1_ii = None
