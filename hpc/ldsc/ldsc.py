...
parser.add_argument('--set-jk-seps-wo-filtering', default=False, action ='store_true',
    help='Sets jackknife block boundaries before filtering regression variants based'
    'on chi-squared statistics. Useful for forcing matched jackknife boundaries across'
    'multiple sets of summary statistics')
