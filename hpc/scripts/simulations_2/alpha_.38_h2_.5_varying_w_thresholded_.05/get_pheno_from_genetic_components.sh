...
#SBATCH --array=0-6
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.05/get_pheno_from_genetic_components_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.05/get_pheno_from_genetic_components_%A_%a.err
#SBATCH --dependency=afterok:21465306
