...
#SBATCH --array=23,24,44,45,46,47,66,67,68,69,70,71,72,73,111#0-153
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.05/get_genetic_components_chr_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.05/get_genetic_components_chr_%A_%a.err
...
EFFECT_SIZE_ROOT_DIR=/n/groups/price/jordan/h2xancestry/data/simulations/effect_sizes_2/w_${w}_alpha_.38_h2_.5_thresholded_.05
