...
#SBATCH --array=87,90,127,136,137,173,187,189,194,205,220,226,232,264,266#0-279
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.05/get_alpha_mix_25_traits_w_unconstrained_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.05/get_alpha_mix_25_traits_w_unconstrained_%A_%a.err
...
RESULTS_DIR=/n/groups/price/jordan/h2xancestry/data/simulations/alpha_mix_2/w_${w}_alpha_.38_h2_.5_thresholded_.05
