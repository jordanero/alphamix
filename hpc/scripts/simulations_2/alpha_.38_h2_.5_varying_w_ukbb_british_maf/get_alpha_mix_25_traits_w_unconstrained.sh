...
#SBATCH --array=0-279
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_ukbb_british_maf/get_alpha_mix_25_traits_w_unconstrained_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_ukbb_british_maf/get_alpha_mix_25_traits_w_unconstrained_%A_%a.err
#SBATCH --dependency=afterok:22021671,22021677,22021681,22021682,22021683,22021692,22021693,22021694,22021695,22021698,22021706,22021708,22021709,22021710,22021716,22021720,22021721,22021722,22021723,22021724,22021728,22021731
...
SCRATCH_DIR=/n/scratch/users/j/jor6523/alpha_mix/simulations_2/w_${w}_alpha_.38_h2_.5_ukbb_british_maf
RESULTS_DIR=/n/groups/price/jordan/h2xancestry/data/simulations/alpha_mix_2/w_${w}_alpha_.38_h2_.5_ukbb_british_maf
