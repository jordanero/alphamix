...
#SBATCH --array=1-70
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_n_causal_20000/gwas_chr18_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_n_causal_20000/gwas_chr18_%A_%a.err
