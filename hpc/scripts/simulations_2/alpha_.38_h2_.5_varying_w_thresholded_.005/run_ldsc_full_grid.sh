...
#SBATCH --array=0-699
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.005/run_ldsc_full_grid_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.005/run_ldsc_full_grid_%A_%a.err
#SBATCH --dependency=afterok:15149831-15149852
...
FIRST_SEED=$(( (SLURM_ARRAY_TASK_ID % 100) * 10 ))
LAST_SEED=$((FIRST_SEED + 9))
W_ARRAY=(0 0.05 0.25 0.5 0.75 0.95 1)
w=${W_ARRAY[$((SLURM_ARRAY_TASK_ID / 100))]}
echo ${w}
echo ${FIRST_SEED}
echo ${LAST_SEED}
...
RESULTS_DIR=/n/groups/price/jordan/h2xancestry/data/simulations/alpha_mix_2/w_${w}_alpha_.38_h2_.5_thresholded_.005_full_grid
