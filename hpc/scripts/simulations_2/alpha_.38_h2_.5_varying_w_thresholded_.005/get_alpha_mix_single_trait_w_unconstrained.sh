...
#SBATCH --array=0-699
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.005/get_alpha_mix_single_trait_w_unconstrained_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.005/get_alpha_mix_single_trait_w_unconstrained_%A_%a.err
...
ldsc_utils.get_alpha_from_grid_across_traits_pmix_thresholded(
    ...
    traits = [f'seed_{seed}' for seed in range(${SEED}, ${SEED} + 1)],
    ...
    out_path_prefix = '${RESULTS_DIR}/seed_${SEED}',
