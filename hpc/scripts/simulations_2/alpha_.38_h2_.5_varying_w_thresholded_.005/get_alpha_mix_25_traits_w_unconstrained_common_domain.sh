...
#SBATCH --array=0,27,28,29,33,34,51,79,90,126,154,207,279#0-279
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.005/get_alpha_mix_25_traits_w_unconstrained_common_domain_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_.005/get_alpha_mix_25_traits_w_unconstrained_common_domain_%A_%a.err
...
ldsc_utils.get_alpha_from_grid_across_traits_pmix_thresholded(
    ...
    out_path_prefix = '${RESULTS_DIR}/seeds_${FIRST_SEED}_${LAST_SEED}_common_domain',
