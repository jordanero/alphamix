...
#SBATCH --array=1-70
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_n_causal_5000/gwas_chr16_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_n_causal_5000/gwas_chr16_%A_%a.err
