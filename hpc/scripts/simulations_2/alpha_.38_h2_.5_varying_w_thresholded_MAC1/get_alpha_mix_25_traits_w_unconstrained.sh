...
#SBATCH --array=3,6,7,13,14,19,44,79,90,155,270#0-279
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_MAC1/get_alpha_mix_25_traits_w_unconstrained_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/simulations_2/alpha_.38_h2_.5_varying_w_thresholded_MAC1/get_alpha_mix_25_traits_w_unconstrained_%A_%a.err
...
SCRATCH_DIR=/n/scratch/users/j/jor6523/alpha_mix/simulations_2/w_${w}_alpha_.38_h2_.5_thresholded_MAC1
RESULTS_DIR=/n/groups/price/jordan/h2xancestry/data/simulations/alpha_mix_2/w_${w}_alpha_.38_h2_.5_thresholded_MAC1
