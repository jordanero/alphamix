...
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/baselineLD2.2_plus_maf_grid/get_alpha_from_grid_w_unconstrained_common_domain_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/baselineLD2.2_plus_maf_grid/get_alpha_from_grid_w_unconstrained_common_domain_%A_%a.err
...
ldsc_utils.get_alpha_from_grid_across_traits_pmix_thresholded(
    ...
    out_path_prefix = '${OUT_DIR}/nh2_selected_w_unconstrained_common_domain_null',
