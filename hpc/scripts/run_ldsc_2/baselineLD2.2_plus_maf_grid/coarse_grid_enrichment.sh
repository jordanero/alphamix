...
#SBATCH --array=0-49
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/baselineLD2.2_plus_maf_grid/coarse_grid_enrichment_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/baselineLD2.2_plus_maf_grid/coarse_grid_enrichment_%A_%a.err
...
ldsc_utils.get_enrichment_fast(
    ...
    out_of_sample_annotation_prefix = '/n/groups/price/jordan/h2xancestry/data/ldscores/1000G_EUR_Phase3/coarse_maf_grid/coarse_maf_grid',
    out_path_list = [f'/n/groups/price/jordan/h2xancestry/data/real_traits_2/baselineLD2.2_plus_maf_grid/{trait}.coarse_grid_enrichment.txt'],
