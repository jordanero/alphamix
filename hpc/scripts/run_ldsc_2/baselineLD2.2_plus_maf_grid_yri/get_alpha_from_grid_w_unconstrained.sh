...
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/baselineLD2.2_plus_maf_grid_yri/get_alpha_from_grid_w_unconstrained_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/baselineLD2.2_plus_maf_grid_yri/get_alpha_from_grid_w_unconstrained_%A_%a.err
#SBATCH --dependency=afterok:22363158
...
LDSC_RESULTS_DIR=/n/groups/price/jordan/h2xancestry/data/real_traits_2/baselineLD2.2_plus_maf_grid_yri
...
ldsc_utils.get_alpha_from_grid_across_traits_pmix_thresholded(
    ...
    grid_annotation_prefix = '/n/groups/price/jordan/h2xancestry/data/ldscores/1000G_EUR_Phase3/maf_grid_yri/maf_grid_yri',
