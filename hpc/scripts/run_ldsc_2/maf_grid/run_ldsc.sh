...
#SBATCH --array=1-50
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/maf_grid/run_ldsc_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/maf_grid/run_ldsc_%A_%a.err
