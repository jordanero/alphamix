...
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/maf_grid/get_alpha_from_grid_w_unconstrained_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/maf_grid/get_alpha_from_grid_w_unconstrained_%A_%a.err


LDSCORE_PREFIX=/n/groups/price/jordan/h2xancestry/data/ldscores/1000G_EUR_Phase3/maf_grid/maf_grid.
BASELINELD_PREFIX=/n/groups/price/jordan/h2xancestry/data/ldscores/1000G_EUR_Phase3/intercept_only/intercept_only.
LDSCORE_PREFIX="${LDSCORE_PREFIX%?}"
BASELINELD_PREFIX="${BASELINELD_PREFIX%?}"
LDSC_RESULTS_DIR=/n/groups/price/jordan/h2xancestry/data/real_traits_2/maf_grid
OUT_DIR=/n/groups/price/jordan/h2xancestry/data/real_traits_2/maf_grid
