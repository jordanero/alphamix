...
#SBATCH -o /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/baselineLD2.2/get_alpha_from_grid_w_unconstrained_ukbiobank_traits_%A_%a.out
#SBATCH -e /n/groups/price/jordan/h2xancestry/scripts/run_ldsc_2/baselineLD2.2/get_alpha_from_grid_w_unconstrained_ukbiobank_traits_%A_%a.err
